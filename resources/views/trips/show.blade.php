            ...
            <div class="card bg-base-200 shadow-lg border border-base-300 ">
                <div class="card-body space-y-4">
                    <div class="flex justify-between items-center">
                        <div><span class="font-semibold">Route:  {{$request->origin}} - {{$request->destination}} </span> </div>
                    ...
                    <div class="flex justify-between mt-5">
                        ...
                        <div class="flex gap-3">
                            ...
                            @if ($trip->requester_id === auth()->id() && $trip->completed_at && !$trip->review)
                                    <a href="{{route('reviews.create', $trip)}}" class="btn btn-accent btn-wide">Leave a review</a>
                            @endif
                        </div>
                    </div>
                </div>
